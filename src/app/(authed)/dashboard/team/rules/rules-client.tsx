      ...
      <div className="flex flex-col gap-3">
        <label className="text-xs">
          ...
          <input
            ...
            className="w-full rounded-md border border-line-strong bg-white px-2 py-1 text-sm dark:bg-stone-900"
          />
        </label>
        <label className="text-xs">
          <span className="mb-1 block text-default">
        ...
        <label className="text-xs">
          ...
          <input
            ...
            className="w-full rounded-md border border-line-strong bg-white px-2 py-1 font-mono text-xs dark:bg-stone-900"
          />
        </label>
